from database_service.database_writer import DatabaseWriter


class VideoWriter(DatabaseWriter):
    def __init__(self):
        DatabaseWriter.__init__(self)
        self._table = 'video_uploading_tasks'

    def write_task_to_db(self, datetime_obj, file_path, session_id, camera_idx):
